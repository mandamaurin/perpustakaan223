                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    $page = (isset($_GET['page'])) ? $_GET['page'] : 1;
                                        ...
                                        if(isset($_GET['qcari'])){
                                            $qcari = $_GET['qcari'];
                                            $sql = "SELECT * FROM peminjaman, anggota, buku, klasifikasi WHERE peminjaman.id_buku = buku.id_buku AND peminjaman.nomor_induk=anggota.nomor_induk AND buku.id_klasifikasi = klasifikasi.id AND peminjaman.batas_pinjam < '$tanggal_sekarang' AND peminjaman.status= 'Belum Dikembalikan' AND anggota.nama_siswa like '%$qcari%' LIMIT ".$limit_start.",".$limit;
                                        } else{
                                            $sql = "SELECT * FROM peminjaman, anggota, buku, klasifikasi WHERE peminjaman.id_buku = buku.id_buku AND peminjaman.nomor_induk=anggota.nomor_induk AND buku.id_klasifikasi = klasifikasi.id  AND peminjaman.batas_pinjam < '$tanggal_sekarang' AND peminjaman.status='Belum Dikembalikan' LIMIT ".$limit_start.",".$limit ;
                                        }
                            ...
                            <!--
                                ...
                                $sql2 = "SELECT COUNT(*) AS jmlh FROM peminjaman WHERE status='Belum Dikembalikan'";
