...
<div id="page-wrapper">
    <div class="row">
        <div class="col-md-6">
            <h2 class="page-header">Data Buku Berdasarkan Pengarang : <?php echo $pengarang['pengarang'] ?></h2>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <!--
                                ...
                                if ($page == 1) { // Jika page adalah pake ke 1, maka disable link PREV
                                    ...
                                    ?>
                                    <li><a href="bukulist-pengarang.php?id=<?php echo $id; ?>&page=1">First</a></li>
                                    <li><a href="bukulist-pengarang.php?id=<?php echo $id; ?>&page=<?php echo $link_prev; ?>">&laquo;</a></li>
                                    <?php
                                }
                                ?>
                                ...
                                $sql2 = "SELECT COUNT(*) AS jmlh FROM buku WHERE pengarang='$id'";
                                ...
                                for ($i = $start_number; $i <= $end_number; $i++) {
                                    ...
                                    ?>
                                    <li <?php echo $link_active; ?>><a href="bukulist-pengarang.php?id=<?php echo $id; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php
                                }
                                ?>
                                ...
                                if ($page == $jumlah_page) { // Jika page terakhir
                                    ...
                                    ?>
                                    <li><a href="bukulist-pengarang.php?id=<?php echo $id;?>&page=<?php echo $link_next; ?>">&raquo;</a></li>
                                    <li><a href="bukulist-pengarang.php?id=<?php echo $id;?>&page=<?php echo $jumlah_page; ?>">Last</a></li>
                                    <?php
                                }
                                ?>
                            </ul>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <?php  
                    echo "<a class='btn btn-primary' data-toggle='tooltip' data-placement='left' title='Cetak' href='cetakbukupengarang.php?id=".$pengarang."' target='_blank'><i class='fa fa-print fa-fw'></i>Cetak</a>";
                    ?>
                </div>
